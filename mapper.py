...
schema_map = {
    "NER": ["人名", "学历", "职位", "国籍"],
    "RE": ["父亲", "丈夫", "邮政编码", "母亲"],
    "EE": [{"event_type": "财经/交易-加息", "trigger": True, "arguments": ["时间"]},
           {"event_type": "财经/交易-降息", "trigger": True, "arguments": ["降息幅度"]}],
    "EET": ["组织关系-解散", "组织关系-裁员", "组织关系-解雇", "竞赛行为-晋级"],
    "EEA": [{"event_type": "财经/交易-加息", "arguments": ["时间"]}, {"event_type": "财经/交易-降息", "arguments": ["降息幅度"]}]
}
...
def get_instruction(language, task, schema, example, input):
    sintructs = []
